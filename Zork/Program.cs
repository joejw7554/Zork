...
namespace Zork
{
    class Program
    {
        ...
        {
            Rooms[0, 0].Description = "You are on a rock steam trail.";
            ...
            Rooms[1, 2].Description = "You are behin the white house. In one corner of the house there is a small window which is slightly ajar.";
